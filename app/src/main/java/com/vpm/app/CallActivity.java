...
import com.vpm.app.fragment.CallFragment;
import com.vpm.app.fragment.HudFragment;
import com.vpm.webrtc.AppRTCClient;

import com.vpm.webrtc.CpuMonitor;
import com.vpm.webrtc.UnhandledExceptionHandler;
import com.vpm.webrtc.WebSocketRTCClient;
import com.vpm.webrtc.connections.PeerConnectionClient;
import com.vpm.webrtc.manager.AppRTCAudioManager;
...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // boolean useSLServer = sharedPref.getBoolean(getString(R.string.pref_enable_sl_server_key), false);

        // Log.d(TAG, "------- USE SL SERVER: '" + useSLServer + " ---------");
    ...
    private void startCall() {
        ...
        //TODO: Rajesh
        //testRTCClient = new SimpleSocketIOClient();
        //testRTCClient.connectToRoom(roomConnectionParameters);
